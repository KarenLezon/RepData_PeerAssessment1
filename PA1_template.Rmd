...
```
A number of the values in the original data contain N/A, `r nna` to be exact.  I have chosen to fill those values with the average number of steps for that interval taken over all days.  The results are stored in a new column:
```{r}
